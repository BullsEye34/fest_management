...
class test1 extends StatefulWidget {
  ...
  test1(var title, var rule, var rate, var ever) {
    titles = title;
    rules = rule;
    rates = rate;
    every = ever;
  ...
  @override
  _test1State createState() => _test1State(titles, rules, rates, every);
}

class _test1State extends State<test1> {
  var titles, rules, rates, every;
  _test1State(var title, var rule, var rate, var ever) {
    titles = title;
    rates = rate;
    rules = rule;
    every = ever;
