...
class rangoli extends StatefulWidget {
  @override
  _rangoliState createState() => _rangoliState();
}

class _rangoliState extends State<rangoli> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Rangoli"), toolbarOpacity: 1, backgroundColor: Color(0xff000000), centerTitle: true,),
      body: Container(
