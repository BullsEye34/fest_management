...
class NFS extends StatefulWidget {
  @override
  _NFSState createState() => _NFSState();
}

class _NFSState extends State<NFS> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("NFS"), toolbarOpacity: 1, backgroundColor: Color(0xff000000), centerTitle: true,),
      body: Container(
