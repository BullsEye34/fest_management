...
class _dmState extends State<dm> {
  ...
  submite() async {
    print(_nameCon.text + _phCon.text + _itemSel);
    Firestore.instance.collection("Main Stage").document("Singing").collection(DateTime.now().toString()).document().setData({
      'Name': _nameCon.text,
      'Phone':_phCon.text,
      'Gender': _itemSel
    });
    return AlertDialog(content: Text("Uploaded"),);
  }
}
