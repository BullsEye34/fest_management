...
class regisGame extends StatefulWidget {
  var every;
  ...
  @override
  _regisGameState createState() => _regisGameState(every);
}

class _regisGameState extends State<regisGame> {
  var every;

  _regisGameState(var ev) {
    every = ev;
  }
