...
class regisSport extends StatefulWidget {
  var every;
  ...
  @override
  _regisSportState createState() => _regisSportState(every);
}

class _regisSportState extends State<regisSport> {
  var every;

  _regisSportState(var ev) {
    every = ev;
  }
      ...
      return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            // Retrieve the text the that user has entered by using the
            // TextEditingController.
            content: Text("Submitted for $every"),
          );
        },
      );
    } else {
